...
## Recovery
- GL3523 Recovery Flow
- GL3590 Recovery Flow
## Code Sign
- GL3523 Code Sign Update Flow
- GL3590 Code Sign_Update Flow
## Tool Architecture
- GL EndUser Tool Class Diagram
- ISP Tool New Architecture Class Diagram
- Hub Fw Update CLI
- HP OCI SDK Architecture
## Tool Update Flow
- Hub update Flow
- Hub_update_Flow
## Hub Bin Code Format
- Hub Code Sign bin Format
## Scaler Update Flow
- RTK Update Flow
- MTK Update Flow
## Draw io 編輯方式
1. 登入google 帳戶 因為都是存放在google driver
1. 選取 使用 diagram.net 開啟
1. 授權
1. 使用自己的google 帳號登入
1. 選擇繼續
1. 就可以登入draw io 相關頁面來觀看或編輯
