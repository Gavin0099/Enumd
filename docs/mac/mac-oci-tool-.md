...
## HP OCI Tool Architecture
https://docs.google.com/document/d/1DbAuoOLvr86leAP8ZnvzuC50QrUdH3DI5imGOIbyCkQ/edit
## 預計要實作功能
1. MAC OCI Tool
1. OCI DLL 
1. hub framework ，要讓OCI Tool 知道可以update的hub 有哪些
1. exe & dll code sign 功能(GUI & silent mode) @Bernie.Hsieh 
1. command line tool 
1. Package 方式
1. 保護機制，只有GL Hub 可以用
### Test Plan
https://ivy-lupin-da9.notion.site/Mac-OCI-Demo-flow-420db67e12a84cc0992c6d176da2857f
Bug List
