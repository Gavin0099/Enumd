...
exported_at: '2026-04-06T13:17:01.908Z'
is_summarized: false
relations:
  manual: []
  inferred:
...
1.執行紅框執行檔(GLDualBankFWTestTool.exe)
2.driver 未安裝時，Driver Version會顯示 None，這時請按下Install
3.安裝完畢後會顯示Driver Version，按下Scan 
4.會顯示兩個bank 的 fw version，藉以觀察Dual Bank 功能是否正常
