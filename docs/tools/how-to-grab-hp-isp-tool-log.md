...
exported_at: '2026-04-06T13:15:44.222Z'
is_summarized: false
relations:
  manual: []
  inferred:
...
1. Open GL_Hub.ini in the HP ISP Tool folder
1. Fill in GL_Hub.ini
1. Open HP ISP Tool
1. Send the log folder in the HP ISP Tool folder back to us for analysis
