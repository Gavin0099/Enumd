...
| run-08 | 2026-05-11 | TBD_AFTER_COMMIT | chatgpt-lane-run8-2026-05-11 | valid | native | yes | high | 0 | 0 | pass | native closeout via runtime entrypoint |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| run-06..run-15 | 1.00 | 3 | 0 | 1.00 | 0.00 | 3 | 1.00 | 0 | 0 | pass | 3 |
