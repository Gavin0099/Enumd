...
| run-05 | 2026-05-08 | remediation patch for mapping/closeout gap | TBD_AFTER_COMMIT | chatgpt-lane-run5-2026-05-08 | yes | high | pass | Validator now checks closeout commit evidence is resolved and matches ledger hash |
